...
Common labels
*/}}
{{- define "globex-db.labels" -}}
helm.sh/chart: {{ include "globex-db.chart" . }}
{{ include "globex-db.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "globex-db.selectorLabels" -}}
app.kubernetes.io/name: {{ include "globex-db.name" . }}
...
*/}}
{{- define "globex-db.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "globex-db.name" .) .Values.serviceAccount.name }}
{{- else }}
